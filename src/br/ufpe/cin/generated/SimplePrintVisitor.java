...
public class SimplePrintVisitor extends AbstractFSTPrintVisitor  {
	...
	public boolean visit(FSTNonTerminal nonTerminal) {
		...
		if (nonTerminal.getType().equals("stylesheet3")) {
			printFeatures(nonTerminal,true);
			{
				FSTNode v=getChild(nonTerminal, "importt");
				if (v!=null) {
					v.accept(this);
				}
			}
	...
	protected boolean isSubtype(String type, String expectedType) {
		...
		if (type.equals("innerRulesetOrAttributes1") && expectedType.equals("innerRulesetOrAttributes")) return true;
		...
		if (type.equals("attribIdentOrString2") && expectedType.equals("attribIdentOrString")) return true;
		if (type.equals("unary_operator1") && expectedType.equals("unary_operator")) return true;
		if (type.equals("innerRulesetOrAttributes2") && expectedType.equals("innerRulesetOrAttributes")) return true;
		...
		if (type.equals("element_name3") && expectedType.equals("element_name")) return true;
		...
		if (type.equals("attribIdentOrString1") && expectedType.equals("attribIdentOrString")) return true;
